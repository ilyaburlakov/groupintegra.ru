...
<body>
    ...
    <section class="cover" id="cover">
        <div class="cover-content" data-aos="fade-up">
            ...
            <h1 class="title">YES Ботаника | Жилой комплекс в Москве</h1>
            <div class="descr">Надежное покрытие сотовой связью в жилом комплексе YES Ботаника у метро Ботанический сад</div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="cards-grid">
                <div class="card" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="card-descr">Жилой комплекс и торговый центр</div>
                </div>
    ...
    <section class="description" id="description">
        <div class="container">
            <p data-aos="fade-up">YES Ботаника — яркий многофункциональный комплекс рядом с метро <a href="https://pioneer.ru/projects/botanica" target="_blank">Ботанический сад</a>, сочетающий жилые пространства, торговую галерею и природные элементы.</p>
        </div>
    </section>
    ...
    <section class="text-section" id="text-section">
        <div class="container">
            <h2>Решение для YES Ботаника</h2>
            <p data-aos="fade-up">Группа Интегра внедрила систему усиления сигнала в жилом комплексе YES Ботаника, обеспечив покрытие в квартирах, торговых зонах и общественных пространствах.</p>
            <p data-aos="fade-up" data-aos-delay="100">Всепогодные антенны на крыше комплекса принимают сигнал в диапазонах 900/1800/2100 МГц, гарантируя поддержку всех стандартов связи.</p>
            <p data-aos="fade-up" data-aos-delay="200">Решение покрывает 100% территории комплекса, создавая комфортную среду для жителей и посетителей.</p>
        </div>
    </section>
