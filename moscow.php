<?php
$region = json_decode('{
    "title": "Слаботочные системы и усиление связи в Москве | Группа Интегра",
    "description": "Проектирование и монтаж слаботочных систем и решений по усилению сотовой связи в Москве для строительных, жилых, коммерческих и офисных объектов.",
    "h1": "Слаботочные системы и усиление связи в Москве",
    "intro": "Группа Интегра работает с проектами в Москве: подключаемся на стадии проектирования, строительства или модернизации объекта и ведём инженерные работы до сдачи.",
    "image": "/images/ostankino.jpg",
    "projects": [
        [
            "Останкино",
            "Бизнес-парк в Москве. Проект по обеспечению покрытия сотовой связью.",
            "/projects/ostankino.php"
        ],
        [
            "YES Технопарк",
            "Апарт-комплекс в Москве с решением по устойчивому покрытию связи.",
            "/projects/yes-technopark.php"
        ],
        [
            "YES Ботаника",
            "Жилой комплекс в Москве с системой покрытия сотовой связи.",
            "/projects/yes-botanica.php"
        ]
    ],
    "name": "Москва"
}', true);
