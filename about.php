    ...
    <div class="container">
        ...
        <div class="story-content">
            <div class="story-text" data-aos="fade-right">
                <h3>Развитие компетенций и цифровых решений</h3>
                <p>С 2007 года компания развивает компетенции в области слаботочных систем, усиления связи и цифрового контроля строительных объектов.</p>
                <p>За годы работы сформированы практические компетенции проектирования, монтажа, пусконаладки и сопровождения инженерных систем.</p>
                <p>Для контроля объектов используется собственная цифровая система: заказчик может видеть отчёты, выполненные объёмы и ход работ онлайн.</p>
            </div>
        ...
        <div class="timeline">
            ...
            <div class="timeline-item" data-aos="fade-right" data-aos-delay="100">
                <div class="timeline-content">
                    ...
                    <p>Начало работы в Санкт-Петербурге с проектов по монтажу и организации слаботочных систем.</p>
                ...
                <div class="timeline-content">
                    ...
                    <div class="timeline-achievements">
                        <ul>
                            ...
                            <li>Расширение компетенций в области видеонаблюдения и СКУД</li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="timeline-item" data-aos="fade-right" data-aos-delay="300">
                <div class="timeline-content">
                    ...
                    <div class="timeline-achievements">
                        <ul>
                            <li>Развитие стандартизированных процессов проектирования и монтажа</li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="timeline-item" data-aos="fade-left" data-aos-delay="400">
                <div class="timeline-content">
                    ...
                    <div class="timeline-achievements">
                        <ul>
                            <li>Начало работы с объектами в Москве и Московском регионе</li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="timeline-item" data-aos="fade-right" data-aos-delay="500">
                <div class="timeline-content">
                    ...
                    <p>Расширение компетенций в области сетевой инфраструктуры, автоматизации и интеграции инженерных систем.</p>
                    <div class="timeline-achievements">
                        <ul>
                            <li>Освоение технологий IoT и BMS</li>
                            <li>Расширение компетенций в области автоматизации и интеграции инженерных систем</li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="timeline-item" data-aos="fade-left" data-aos-delay="600">
                <div class="timeline-content">
                    ...
                    <p>Развитие удалённого контроля и цифровых инструментов ведения объектов.</p>
                    <div class="timeline-achievements">
                        <ul>
            ...
            <div class="timeline-item" data-aos="fade-right" data-aos-delay="700">
                <div class="timeline-content">
                    ...
                    <h3>2024 - Развитие цифрового контроля</h3>
                    <p>Развитие собственной цифровой системы для онлайн-контроля строительных проектов и прозрачного ведения работ.</p>
                    <div class="timeline-achievements">
                        <ul>
                ...
                <div class="timeline-content">
                    ...
                    <div class="timeline-achievements">
                        <ul>
                            ...
                            <li>Развитие цифровых инструментов управления объектами</li>
                        </ul>
                    </div>
                </div>
