    ...
    <section class="home-section">
        <div class="home-container">
            <div class="section-head">
                ...
                <p>Подключаемся на любом этапе: от обследования и проектирования до монтажа, контроля и сдачи систем.</p>
            </div>
            ...
            <div class="service-grid">
                <article class="service-card">
                    ...
                    <p>Обследуем объект, рассчитываем покрытие и проектируем систему усиления связи. Выполняем монтаж, настройку, измерения и подготовку системы к сдаче.</p>
                    <a href="/gsm.php">О направлении →</a>
                </article>
                <article class="service-card">
                    <div class="service-number">02 / СЛАБОТОЧНЫЕ СИСТЕМЫ</div>
                    <h3>Слаботочные системы</h3>
                    <p>СКС и ЛВС, видеонаблюдение, СКУД, АПС, СОУЭ и другие системы. Организуем работы на объекте, координируем монтаж и контролируем результат.</p>
                    <a href="/slabotchka.php">О направлении →</a>
                </article>
                <article class="service-card">
                    <div class="service-number">03 / КОНТРОЛЬ</div>
                    <h3>Аудит и консультации</h3>
                    <p>Проверяем проект, смету, технические решения и фактическое выполнение работ. Выявляем ошибки, несоответствия и проблемы до приёмки объекта.</p>
