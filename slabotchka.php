...
<head>
    ...
    <title>Слаботочные системы — проектирование и монтаж | Группа Интегра</title>
    ...
    <link rel="canonical" href="https://groupintegra.ru/slabotchka.php">
    ...
    <div class="container">
        <div class="hero-content">
            ...
            <div class="hero-highlight" data-aos="fade-up" data-aos-delay="150">
                19 лет работы с 2007 года • Цифровизация и онлайн-контроль объектов
            </div>
    ...
    <div class="container">
        ...
        <div class="story-content">
            <div class="story-text" data-aos="fade-right">
                ...
                <p>С 2007 года компания развивает компетенции в области проектирования, монтажа и сопровождения слаботочных систем.</p>
                <p>Сегодня Группа Интегра развивает компетенции в проектировании, монтаже и сопровождении слаботочных систем. Для контроля объектов используется собственная цифровая система с онлайн-отчётностью и контролем выполненных объёмов.</p>
                
                <div class="story-highlights">
                    <h4>Ключевые достижения нашего развития:</h4>
                    <ul>
                        <li>2007-2010: Формирование первых компетенций и развитие компании</li>
            ...
            <div class="service-card" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="service-features">
                    <ul>
                        ...
                        <li>Гарантия — в соответствии с договором и спецификацией проекта</li>
                        <li>Медные и оптические линии — в соответствии с требованиями проекта</li>
                    </ul>
                </div>
...
<img src="/images/bms.jpg" alt="Группа Интегра Системы автоматизации зданий (BMS)" class="service-image">                <h3>Системы автоматизации зданий (BMS)</h3>
                ...
                <div class="service-features">
                    <ul>
                        ...
                        <li>Оптимизация работы инженерных систем</li>
                    </ul>
                </div>
                ...
                <div class="audience-content">
                    ...
                    <div class="audience-benefits">
                        ...
                        <ul>
                            ...
                            <li>Цифровой контроль позволяет отслеживать состояние работ и выполненных объёмов онлайн</li>
                        </ul>
                    </div>
    ...
    <div class="container">
        ...
        <div class="advantages-grid">
            <div class="advantage-card" data-aos="fade-up" data-aos-delay="100">
                ...
                <h3>19 лет работы с 2007 года</h3>
                <p>Проектируем и реализуем слаботочные системы для строительных и коммерческих объектов.</p>
            </div>
            ...
            <div class="advantage-card" data-aos="fade-up" data-aos-delay="400">
                ...
                <h3>Поддержка 365 дней в году</h3>
                <p>Техническая поддержка и сопровождение в течение года.</p>
            </div>
        </div>
    </div>
</section>
