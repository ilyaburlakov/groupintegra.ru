    ...
    <style>
        ...
        * {
        ...
        .hero::before {
            ...
            width: 100%;
            height: 100%;
            background: linear-gradient(90deg, rgba(8,28,48,.72), rgba(8,28,48,.38), rgba(8,28,48,.62)), url('/images/img30.jpg') center/cover no-repeat;
    ...
    <div class="container">
        ...
        <div class="additional-services-grid">
            ...
            <div class="additional-service-card" data-aos="fade-up" data-aos-delay="200">
                ...
                <p>Регулярное ТО систем, профилактические работы и мониторинг состояния оборудования.</p>
            </div>
...
<script type="application/ld+json">
{
    ...
    "offers": {
        "@type": "Offer",
        "description": "Комплексные услуги по проектированию, монтажу и сопровождению слаботочных систем"
    }
}
</script>
